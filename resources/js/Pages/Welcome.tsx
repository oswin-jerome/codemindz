                    ...
                    {auth.user ? (
                        ...
                        <>
                            <Link
                                ...
                                className="font-semibold mr-4 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                            >
                                C Log in
                            </Link>
                            <Link
